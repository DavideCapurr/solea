...
/// Fonti scientifiche delle stime mostrate da Abbronzo (indice UV, fototipo, limite
...
struct ScientificSourcesView: View {
    ...
    private let topics: [Topic] = [
        Topic(
            ...
            footer: "Abbronzo usa l'indice UV per stimare il rischio di scottatura e le ore più prudenti.",
            sources: [
                Source(
    ...
    var body: some View {
        NavigationStack {
            List {
                Section {
                    Text("Abbronzo fornisce stime informative basate su fonti di salute pubblica e letteratura scientifica. Non è un dispositivo medico e non sostituisce il parere di un medico o di un dermatologo.")
                        .font(.subheadline)
...
/// restano facili da trovare ovunque Abbronzo mostri stime di salute.
