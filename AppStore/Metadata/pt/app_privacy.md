...
Tanora não transmite dados pessoais para servidores próprios nem para terceiros.
...
- **Location**: usada na app apenas para chamar o WeatherKit da Apple (índice
  ...
  Tanora não regista nem transmite a localização para outro lado.
  → *Não recolhida pela Tanora.*
- **Health & Fitness**: a Tanora **escreve** Time in Daylight no HealthKit do
...
- **Photos**: o diário fotográfico guarda as imagens escolhidas pelo utilizador
  no SwiftData local (sandbox da app). Sem upload para a Tanora nem para
  terceiros. → *Não recolhida pela Tanora.*
- **Game Center**: tabelas de classificação e troféus são geridos pela Apple
  ...
  privacidade da Apple, não pela da Tanora. → *Não recolhida pela Tanora.*
...
Caso uma release futura defina `SOLEA_COACH_PROXY_URL` (ex.: Tanora Plus com
